...
const Return = () => {
    ...
    const {customer_details, client_reference_id, created, amount_total} = session;
          ...
          <div className="container">
            ...
            <div className="row">
              ...
              <div className="col-xl-4">
                ...
                <ul className="list-unstyled">
                  <li className="text-muted"><GrStripe className="fas fa-circle" style={{ color: '#94c045' }}></GrStripe> <span className="fw-bold">Stripe ID:</span> {client_reference_id
}</li>
